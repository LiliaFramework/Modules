...
MODULE.version = 1.19
MODULE.desc = "Provides chat commands that open links to community resources such as the website or Discord. Command names and URLs are fully configurable."
MODULE.Public = true
