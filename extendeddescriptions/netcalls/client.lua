net.Receive("OpenDetailedDescriptions", function()
    ...
    frame:Center()
    frame:SetTitle(string.format("%s's Detailed Description", ply:Name()))
    frame:MakePopup()
    ...
    htmlPanel:Dock(FILL)
    if descURL ~= "No description available." then htmlPanel:OpenURL(descURL) end
end)
