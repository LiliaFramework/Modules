...
function MODULE:DrawCharInfo(client, _, info)
	...
	info[#info + 1] = {"⚠️ " .. L("afkForTime", string.NiceTime(timeAFK)), Color(255, 165, 0)}
end
...
function MODULE:HUDPaintBackground()
	...
	draw.SimpleText("⚠️ " .. L("youAreAFK"), "liaBigFont", x + width * 0.5, y + 15, Color(255, 165, 0), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
