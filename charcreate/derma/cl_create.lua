      ...
      local steps = {
        {
          ...
          canProceed = function(grp)
            ...
            if fn == grp.firstname.placeholder then
              fn = nil
            end

            local ln = grp.lastname:GetText()
            if ln == grp.lastname.placeholder then
              ln = nil
            end
        ...
        },
        {
          ...
          canProceed = function(grp)
            if grp and grp.curSel and grp.curSel > 0 then return true end
          end,
          getVal = function(grp, payload)
