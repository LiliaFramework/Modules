	...
	timer.Simple(1, function()
		...
		function GAMEMODE:MouthMoveAnimation(ply)
			...
			for i = 0, FlexNum - 1 do
				...
				if Name == "jaw_drop" or Name == "right_part" or Name == "left_part" or Name == "right_mouth_drop" or Name == "left_mouth_drop" then ply:SetFlexWeight(i, math.max((ply.cigaMouthOpenAmt or 0) * 0.5, math.Clamp(((ply.cigaTalkingEndtime or 0) - CurTime()) * 3.0, 0, 1) * math.Rand(0.1, 0.8))) end
			end
		end
	end)
end)
