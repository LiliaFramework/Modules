    ...
    hook.Add("EntityRemoved", "ARC9RemoveGrenade", function(entity)
        if GrenadeClass[entity:GetClass()] then
            ...
            if IsValid(client) and client:IsPlayer() and client:GetCharacter() then
                ...
                if isstring(ammoName) and client:GetAmmoCount(ammoName) < 1 and entity.liaItem and entity.liaItem.Unequip then entity.liaItem:Unequip(client, false, true) end
            end
        end
    end)
end
