...
function MODULE:HUDPaint()
    ...
    if CAMI.PlayerHasAccess(client, "Lilia - Staff Permissions - Development HUD", nil) then draw.SimpleText("| " .. client:SteamID64() .. " | " .. client:SteamID() .. " | " .. os.date("%m/%d/%Y | %X", os.time()) .. " | ", "DevHudText", w / 5.25, h / 1.12, Color(210, 210, 210, 255), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER) end
    if CAMI.PlayerHasAccess(client, "Lilia - Staff Permissions - Staff HUD", nil) then
